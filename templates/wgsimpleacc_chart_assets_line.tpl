...
<a href="statistics.php?op=assets" class="btn btn-primary<{if $showoffline|default:0 == 0}> disabled<{/if}> wgsa-btn-list" title="<{$smarty.const._MD_WGSIMPLEACC_SHOW_ONLINE}>"><{$smarty.const._MD_WGSIMPLEACC_SHOW_ONLINE}></a><a href="statistics.php?op=assets&amp;showoffline=1" class="btn btn-primary<{if $showoffline|default:0 == 1}> disabled<{/if}> wgsa-btn-list" title="<{$smarty.const._MD_WGSIMPLEACC_SHOW_ALL}>"><{$smarty.const._MD_WGSIMPLEACC_SHOW_ALL}></a>
