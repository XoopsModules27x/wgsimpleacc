<{if $accountlist_collapsible|default:''}>
    ...
    <div class='col-12' style="margin:auto">
        <p class="pull-right wgsa-btn-list">
            <a class='btn btn-warning wgsa-btn' href='accounts.php' title='<{$smarty.const._MD_WGSIMPLEACC_REFRESH}>'><{$smarty.const._MD_WGSIMPLEACC_REFRESH}></a>
    ...
    <div class='col-sm-12 col-sm-12'>
        <div class='panel list-sort-panel'>
            ...
            <div class='panel-body list-sort-panelbody'>
                ...
                <p class='center'>
                    <a class='btn btn-secondary wgg-btn' href='accounts.php' title='<{$smarty.const._MD_WGSIMPLEACC_REFRESH}>'>
...
<{if $compare_list|default:''}>
    <table class='table table-bordered'>
        ...
        <tr class='head'>
            ...
            <th class="center"><{$smarty.const._MD_WGSIMPLEACC_ALLOCATIONS}> (<{$smarty.const._MD_WGSIMPLEACC_ONLINE}>)</th>
...
<{if $accountsCount|default:0 == 0}>
    <{$smarty.const._MD_WGSIMPLEACC_THEREARENT_ACCOUNTS}>
<{/if}>
