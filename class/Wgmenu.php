...
class Wgmenu
{
    ...
    public function getMenuitemsDefault(): array
    {
        ...
        if ($permissionsHandler->getPermAllocationsView()) {
            ...
            if ($permissionsHandler->getPermAllocationsSubmit()) {
                if ((bool)$helper->getConfig('use_cascadingacc')) {
                    $subcount++;
                    $items[$subcount]['name']  = \_MD_WGSIMPLEACC_ALLOCATION_ACCOUNTS_COMPARE;
                    $items[$subcount]['url'] =  'allocations.php?op=compare_accounts';
                }
                $subcount++;
                $items[$subcount]['name']  = \_MD_WGSIMPLEACC_ALLOCATION_SUBMIT;
                $items[$subcount]['url'] =  'allocations.php?op=new';
            }
        }
        if ($permissionsHandler->getPermAccountsView()) {
            $subcount++;
            $items[$subcount]['name']  = \_MD_WGSIMPLEACC_ACCOUNTS_LIST;
        ...
        if ($permissionsHandler->getPermGlobalView()) {
            if ($permissionsHandler->getPermTransactionsView()) {
                $subcount++;
                $items[$subcount]['name']  = \_MD_WGSIMPLEACC_STATISTICS . ' ' . \_MD_WGSIMPLEACC_ALLOCATIONS;
                $items[$subcount]['url'] =  'statistics.php?op=allocations';
                $subcount++;
                $items[$subcount]['name']  = \_MD_WGSIMPLEACC_STATISTICS . ' ' . \_MD_WGSIMPLEACC_ASSETS;
                $items[$subcount]['url'] =  'statistics.php?op=assets';
                $subcount++;
                $items[$subcount]['name']  = \_MD_WGSIMPLEACC_STATISTICS . ' ' . \_MD_WGSIMPLEACC_ACCOUNTS_LINECHART;
                $items[$subcount]['url'] =  'statistics.php?op=accounts';
                $subcount++;
                $items[$subcount]['name']  = \_MD_WGSIMPLEACC_STATISTICS . ' ' . \_MD_WGSIMPLEACC_ACCOUNTS_BARCHART;
                $items[$subcount]['url'] =  'statistics.php?op=hbar_accounts';
            }
            if ($permissionsHandler->getPermBalancesView()) {
                $subcount++;
                $items[$subcount]['name']  = \_MD_WGSIMPLEACC_STATISTICS . ' ' . \_MD_WGSIMPLEACC_BALANCES;
                $items[$subcount]['url'] =  'statistics.php?op=balances';
            }
        }
        if ($permissionsHandler->getPermFileDirView()) {
            $subcount++;
            $items[$subcount]['name']  = \_MD_WGSIMPLEACC_FILES_LIST;
            $items[$subcount]['url'] =  'files.php?op=list';
            if ($permissionsHandler->getPermFileDirSubmit()) {
                $subcount++;
                $items[$subcount]['name']  = \_MD_WGSIMPLEACC_FILE_ADD;
        ...
        if ($permissionsHandler->getPermGlobalView()) {
            ...
            if ($permissionsHandler->getPermTransactionsView()) {
                $subcount++;
                $items[$subcount]['name']  = \_MD_WGSIMPLEACC_OUTPUTS . ' ' . \_MD_WGSIMPLEACC_TRANSACTIONS_LIST;
                $items[$subcount]['url'] =  'outputs.php?op=transactions';
            }
            if ($permissionsHandler->getPermBalancesView()) {
                $subcount++;
                $items[$subcount]['name']  = \_MD_WGSIMPLEACC_OUTPUTS . ' ' . \_MD_WGSIMPLEACC_BALANCES;
    ...
    public function getMenuitemsStartmin(): array
    {
        ...
        if ($permissionsHandler->getPermTransactionsView()) {
            ...
            if ($permissionsHandler->getPermTransactionsSubmit()) {
                ...
                $nav_items1[] = ['href' => '#', 'icon' => '<i class="fa fa-money fa-fw fa-lg"></i>', 'label' => \_MD_WGSIMPLEACC_TRANSACTIONS, 'sub_items2' => $nav_items2];
            } else {
        ...
        if ($permissionsHandler->getPermClientsView() && $helper->getConfig('use_clients')) {
            ...
            if ($permissionsHandler->getPermClientsSubmit()) {
                ...
                $nav_items1[] = ['href' => '#', 'icon' => '<i class="fa fa-users fa-fw fa-lg"></i>', 'label' => \_MD_WGSIMPLEACC_CLIENTS, 'sub_items2' => $nav_items2];
            } else {
        ...
        if ($permissionsHandler->getPermAllocationsView()) {
            ...
            if ($permissionsHandler->getPermAllocationsSubmit()) {
                ...
                $nav_items1[] = ['href' => '#', 'icon' => '<i class="fa fa-sitemap fa-fw fa-lg"></i>', 'label' => \_MD_WGSIMPLEACC_ALLOCATIONS, 'sub_items2' => $nav_items2];
            } else {
        ...
        if ($permissionsHandler->getPermAccountsView()) {
            ...
            if ($permissionsHandler->getPermAccountsSubmit()) {
                ...
                $nav_items1[] = ['href' => '#', 'icon' => '<i class="fa fa-table fa-fw fa-lg"></i>', 'label' => \_MD_WGSIMPLEACC_ACCOUNTS, 'sub_items2' => $nav_items2];
            } else {
        ...
        if ($permissionsHandler->getPermAssetsView()) {
            ...
            if ($permissionsHandler->getPermAssetsSubmit()) {
                ...
                $nav_items1[] = ['href' => '#', 'icon' => '<i class="fa fa-credit-card fa-fw fa-lg"></i>', 'label' => \_MD_WGSIMPLEACC_ASSETS, 'sub_items2' => $nav_items2];
            } else {
        ...
        if ($permissionsHandler->getPermTratemplatesView() || $permissionsHandler->getPermOuttemplatesView()) {
            ...
            $nav_items1[] = ['href' => '#', 'icon' => '<i class="fa fa-paste fa-fw fa-lg"></i>', 'label' => \_MD_WGSIMPLEACC_TEMPLATES, 'sub_items2' => $nav_items2];
        }
        if ($permissionsHandler->getPermBalancesView()) {
            $nav_items2 = [];
            if ($permissionsHandler->getPermBalancesSubmit()) {
                ...
                $nav_items1[] = ['href' => '#', 'icon' => '<i class="fa fa-tasks fa-fw fa-lg"></i>', 'label' => \_MD_WGSIMPLEACC_BALANCES, 'sub_items2' => $nav_items2];
            } else {
        ...
        if ($permissionsHandler->getPermGlobalView()) {
            ...
            if ($permissionsHandler->getPermTransactionsView() || $permissionsHandler->getPermBalancesView()) {
                $nav_items1[] = ['href' => '#', 'icon' => '<i class="fa fa-bar-chart-o fa-fw fa-lg"></i>', 'label' => \_MD_WGSIMPLEACC_STATISTICS, 'sub_items2' => $nav_items2];
            }
        }
        if ($permissionsHandler->getPermFileDirView()) {
            $nav_items2 = [];
            if ($permissionsHandler->getPermFileDirSubmit()) {
                ...
                $nav_items1[] = ['href' => '#', 'icon' => '<i class="fa fa-files-o fa-fw fa-lg"></i>', 'label' => \_MD_WGSIMPLEACC_FILES, 'sub_items2' => $nav_items2];
            } else {
        ...
        if ($permissionsHandler->getPermGlobalView()) {
            ...
            if ($permissionsHandler->getPermTransactionsView() || $permissionsHandler->getPermBalancesView()) {
                $nav_items1[] = ['href' => '#', 'icon' => '<i class="fa fa-download fa-fw fa-lg"></i>', 'label' => \_MD_WGSIMPLEACC_OUTPUTS, 'sub_items2' => $nav_items2];
            }
        }
