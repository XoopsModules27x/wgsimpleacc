...
switch ($op) {
    ...
    default:
        ...
        if ($filhistoriesCount > 0) {
            ...
            $GLOBALS['xoopsTpl']->assign('error', \_MD_WGSIMPLEACC_THEREARENT_FILHISTORIES);
        }
        break;
    case 'delete':
        $templateMain = 'wgsimpleacc_admin_filhistories.tpl';
        ...
        if (isset($_REQUEST['ok']) && 1 == $_REQUEST['ok']) {
            ...
            if ($filhistoriesHandler->delete($filhistoriesObj)) {
                \redirect_header('filhistories.php', 3, \_MD_WGSIMPLEACC_FORM_DELETE_OK);
            } else {
            ...
            $customConfirm = new Common\Confirm(
                ...
                $_SERVER['REQUEST_URI'],
                \sprintf(\_MD_WGSIMPLEACC_FORM_SURE_DELETE, $filName), _MD_WGSIMPLEACC_FORM_DELETE_CONFIRM, _MD_WGSIMPLEACC_FORM_DELETE_LABEL);
