<tr id='asId_<{$asset.as_id}>'>
    ...
    <td>
        ...
        <{/if}>
        <a class="btn btn-secondary wgsa-btn-list" href="transactions.php?op=list&displayfilter=1&amp;as_id=<{$asset.as_id}>" title='<{$smarty.const._MD_WGSIMPLEACC_TRANSACTIONS}>'><{$smarty.const._MD_WGSIMPLEACC_TRANSACTIONS}></a>
    </td>
</tr>