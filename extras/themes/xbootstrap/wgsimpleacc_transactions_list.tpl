<tr class="row-class-<{$transaction.tra_class}>" id='traId_<{$transaction.tra_id}>'>
    ...
    <td class="center">
        <{if $transaction.waiting|default:''}>
            ...
            <{/if}>
        <{/if}>
        <a class='btn btn-success right' href='transactions.php?op=show<{$histOp}>&amp;tra_id=<{$transaction.tra_id}><{$traOp}>' title='<{$smarty.const._MD_WGSIMPLEACC_DETAILS}>'><i class="fa fa-search fa-fw"></i></a>
        <{if $permSubmit && $transaction.editable}>
