<{if $showList|default:''}>
    ...
    <{if $clientsCount|default:0 > 0}>
        <{if $showFiltered|default:false}>
            <h3><{$smarty.const._MD_WGSIMPLEACC_CLIENTS_FILTERED}></h3>
        <{else}>
            <h3><{$smarty.const._MD_WGSIMPLEACC_CLIENTS_LIST}></h3>
        <{/if}>
        <div class='table-responsive'>
            <table class='table table-striped'>
                <thead>
                    <tr>
                        <th>
                            <{$smarty.const._MD_WGSIMPLEACC_CLIENT_NAME}>
                        ...
                        <th><{$smarty.const._MD_WGSIMPLEACC_CLIENT_FULLADDRESS}></th>
                        <th><{$smarty.const._MD_WGSIMPLEACC_CLIENT_PHONE}></th>
                        <th><{$smarty.const._MD_WGSIMPLEACC_CLIENT_VAT}></th>
                        ...
                        <th class="center">
                            <{$smarty.const._MD_WGSIMPLEACC_DATECREATED}>
    ...
    <{else}>
        <{if $showFiltered|default:false}>
            <{$smarty.const._MD_WGSIMPLEACC_CLIENTS_FILTEREDNON}>
        <{else}>
            <{$smarty.const._MD_WGSIMPLEACC_THEREARENT_CLIENTS}>
        <{/if}>
    <{/if}>
<{else}>
    <h3><{$smarty.const._MD_WGSIMPLEACC_CLIENT_DETAILS}></h3>
    <{foreach item=client from=$clients name=client}>
